...
class DC_and_CE_and_CBDC_loss(nn.Module):
    ...
    def forward(
        ...
        cbdice_loss = (
            self.cbdice(net_output, target, t_skeletonize_flage=t_skeletonize_flage)
            if self.weight_cbdice != 0
            else 0
        )
        ...
        result = (
            ...
            + self.weight_cbdice * cbdice_loss
        )
        return result
...
class DC_and_CE_and_CL_M_DC_loss(nn.Module):
    ...
    def forward(
        ...
        clMdice_loss = (
            self.clMdice(net_output, target, t_skeletonize_flage=t_skeletonize_flage)
            if self.weight_clMdice != 0
            else 0
        )
        ...
        result = (
            self.weight_ce * ce_loss
            + self.weight_dice * dc_loss
            + self.weight_clMdice * clMdice_loss
        )
        return result
